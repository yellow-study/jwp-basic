            ...
            <div class="content-main">
                ...
                <div class="qna-comment">
                    <div class="qna-comment-slipp">
                        <p class="qna-comment-count"><strong id="count-of-comment">${question.countOfComment}</strong>개의
                            의견</p>
                                    ...
                                    <div class="article-header">
                                        ...
                                        <div class="article-header-text">
                                            ...
                                            <div class="article-header-time"><fmt:formatDate
                                                    pattern="yyyy-MM-dd HH:mm:ss" value="${answer.createdDate}"/></div>
                                        </div>
                                    </div>
                                        ...
                                        <ul class="article-util-list">
                                            <li>
                                                <a class="link-modify-article"
                                                   href="#" onclick="updateAnswer(${answer.answerId});">수정</a>
                                            </li>
                                            <li>
